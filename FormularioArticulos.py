...
class FormularioArticulos:
    ...
    def consulta_por_codigo(self):
        ...
        self.entrydescripcion=ttk.Entry(self.labelframe2, textvariable=self.description, state="readonly")
    ...
    def sonsultar(self)
        ...
        if len(respuesta)>0:
            ...
            self.precio.set("")
            mb.showinfo("Informacion", "No exite un articulo con dicho codigo")
